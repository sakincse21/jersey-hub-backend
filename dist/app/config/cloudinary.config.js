...
const uploadBufferToCloudinary = (buffer, fileName) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return new Promise((resolve, reject) => {
            ...
            const bufferString = new stream_1.default.PassThrough();
        ...
        console.log(error);
        throw new appErrorHandler_1.default(401, `Error uploading file: ${error.message}`);
    }
});
...
const deleteImageFromCloudinary = (url) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        throw new appErrorHandler_1.default(http_status_1.default.BAD_REQUEST, "Cloudinary image deletion failed", error.message);
    }
});
